...
<div style="padding: 70px 550px 10px">
    <form   method="post" action="querybook.html" class="form-inline"  id="searchform">
        <div class="input-group">
            <input type="text" placeholder="Enter Book title" class="form-control" id="search" name="searchWord" class="form-control">
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    ...
                    <td><a href="deletebook.html?bookId=<c:out value="${alog.sernum}"></c:out>"><button type="button" class="btn btn-danger btn-xs">Delete</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>

...
public class ReaderInfoDao {
    ...
    public ArrayList<ReaderInfo> getAllReaderInfo() {
        ...
        jdbcTemplate.query(ALL_READER_INFO_SQL, new ResultSetExtractor<ArrayList<ReaderInfo>>() {
            @Override
            public ArrayList<ReaderInfo> extractData(ResultSet resultSet) throws SQLException, DataAccessException {

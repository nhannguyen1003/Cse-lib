...
public class LendDao {
    ...
    private final static String BOOK_LEND_SQL_ONE="INSERT INAvailable _list (book_id,reader_id,lend_date) VALUES ( ? , ? , ? )";
    ...
    public ArrayList<Lend> lendList(){
        ...
        jdbcTemplate.query(LEND_LIST_SQL, new ResultSetExtractor<ArrayList<Lend>>() {
            @Override
            public ArrayList<Lend> extractData(ResultSet resultSet) throws SQLException, DataAccessException {
